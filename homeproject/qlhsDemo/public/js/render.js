    ...
    .map((s) => {
      return `
            <tr>
                  ...
                  <td class="column2">${s.first_name}</td>
                  <td class="column3">${s.last_name}</td>
                  <td class="column4"><a href="mailto:${s.email}">
                        ${s.email}
                    </a></td>
                  <td class="column5"><a href="tel:${s.phone}">
                        ${s.phone}
                    </a></td>
                  <td class="column6"><a href="student.html?studentId=${s.id}">
